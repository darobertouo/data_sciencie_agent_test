...
from .sub_agents import social_listening_agent

from .tools import call_alloydb_agent, call_analytics_agent, call_bigquery_agent, call_social_listening_agent
    ...
    for dataset in _dataset_config["datasets"]:
        if dataset["type"] == "bigquery":
            tools.append(call_bigquery_agent)
             # incluir o social_listening_agent quando estivermos usando BigQuery
            tools.append(call_social_listening_agent)
            sub_agents.append(bqml_agent)
            # registrar também o social_listening_agent como sub-agent
            sub_agents.append(social_listening_agent)
